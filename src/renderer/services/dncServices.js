...
export default {
  ...
  downloadProgram (programId, roomId, key, iv) {
    console.log({program_id: programId, room_id: roomId, 'key': key, 'iv': iv})
    return api.post('download_program', {program_id: programId, room_id: roomId, 'key': key, 'iv': iv})
  }
}
